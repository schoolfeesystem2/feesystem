...
import { Users, DollarSign, BarChart3, Shield, ArrowRight, CheckCircle, Play } from "lucide-react";
    ...
    const fetchVideoUrl = async () => {
      try {
        const { data, error } = await (supabase as any)
          ...
          .single();
        if (!error && data?.value) setVideoUrl(data.value);
      } catch {}
    };
    fetchVideoUrl();
  }, []);
  ...
  return <div className="min-h-screen gradient-hero">
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground max-w-xl mx-auto">
            Watch a quick demo to see how SchoolFee System can transform your school's fee management.
          </p>
        </div>
        <div className="max-w-3xl mx-auto">
          <div className="relative rounded-2xl overflow-hidden shadow-xl border aspect-video">
            <iframe
              src={getEmbedUrl(videoUrl)}
              title="SchoolFee System Demo"
    ...
    <section className="container mx-auto px-4 py-16">
      <div className="bg-card border rounded-2xl p-8 md:p-12 shadow-lg">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-3xl font-bold text-foreground mb-4">Why Schools Choose Us</h2>
